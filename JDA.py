...
class JDA:
    def __init__(self, kernel_type='primal', dim=30, lamb=1.0, gamma=1.0, T=10):
        '''
        Init func
...
if __name__ == '__main__':
    ...
    for index, datasets in enumerate(list_datasets):
        ...
        for dataset in datasets:
            ...
            jda = JDA(kernel_type='rbf', dim=dim, lamb=lamb, gamma=0.5, T=10)
            acc, _, _ = jda.fit_predict(Xs, Ys, Xt, Yt)

            file = open('/home/nguyenhoai2/Grid/results/MEDA-Extend/' + dataset + '/JDA', 'w')
            file.write(str(acc))
            file.close()